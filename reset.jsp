						...
						<section class="panel">
							<div class="panel-body">
								<div class="row">
									...
									<a href='#' data-toggle="modal" data-target="#add"><i class='fa fa-minus'></i> RESET</a>
<!-- Modal -->
      ...
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">RESET</h4>
	      ...
	      <div class="modal-footer">
	        ...
	        <input name="reset" type="reset" src="" class="delete-db" />
	        <button type="submit" class="delete-db" >YES</button>
	      </div>
	  </form>
    </div>
  </div>
...
<!-- Modal -->
<div class="modal fade" id="reset<%=i%>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">  
        <h4 class="modal-title" id="myModalLabel">RESET '<%=c.getName() %>'</h4>
      </div>
      <form name='reset'>
	      ...
	      <input type="button" name="reset" value="Reset" onclick="this.form.reset();">
	        	...
	        	Are you sure to Reset this client?
	      </div>
	      <div class="modal-footer">
	        <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
	        <button type="submit" class="delete-db">Yes</button>
